...
foreach (array('generals','elementor') as $file) {
	...
	require QS_PADDLE_INTEGRATION_DIR_PATH .'/src/helpers/'.$file.'.php';
}
...
require QS_PADDLE_INTEGRATION_DIR_PATH .'/src/system/config/config_function.php';

\QS_Paddle_Integration\system\App::register_services();
