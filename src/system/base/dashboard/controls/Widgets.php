...
class Widgets extends Form{
    ...
    public $action_key = 'qs_paddle_intregration_components_options';
    public $option_key = 'qs_paddle_intregration_components';
    public $nonce      = '_qs_paddle_intregration_components';
    ...
    function _qs_paddle_components_options(){
        ...
        if ( wp_doing_ajax() ){
            $_SESSION['qs_paddle_intregration_dash_message'] = esc_html__('You cannot update settings','qs-paddle-integration');
            wp_die();
        }else{
            ...
            $_SESSION['qs_paddle_intregration_dash_message'] = esc_html__('Widgets Settings updated','qs-paddle-integration');
