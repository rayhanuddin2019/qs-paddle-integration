<?php 
namespace QS_Paddle_Integration\extension\generalwidgets;

use QS_Paddle_Integration\base\elementor\Widget_Settings as Mangocube_Widget_Settings;
use QS_Paddle_Integration\base\elementor\style_controls\box\Widget_Box_Style;
use QS_Paddle_Integration\base\elementor\style_controls\common\Widget_Common_Style;
use QS_Paddle_Integration\base\elementor\style_controls\position\Widget_Style_Position;
...
Abstract Class Widget_Base extends \Elementor\Widget_Base {
    ...
    */
    ...
    public function set_config($real_slug) {

        $all_configs  =  qs_paddle_intregration_genwidget_config()->all();
    ...
    public function get_refined_slug() {
        ...
        $slug  = str_replace(['qs_paddle_integration\extension\generalwidgets\widgets'],[''],strtolower(get_called_class()) );
    ...
    public function render(){
        qs_paddle_intregration_load_wc();
        $this->html();
